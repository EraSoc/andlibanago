...
public class FavoriteCouponAdapter extends RecyclerView.Adapter<FavoriteCouponAdapter.PersonViewHolder>{
    ...
    public FavoriteCouponAdapter(List<com.link2loyalty.bwigomdlib.models2.coupon.LovRecomendados> couponModels, Context context,
    ...
    public void onBindViewHolder(final PersonViewHolder personViewHolder, final int i) {
        ...
        Glide.with(mContext)
                .load(couponModels.get(i).getCup())
                .dontTransform()
    ...
    private void showPopupMenu(View view,int position) {
        ...
        inflater.inflate(R.menu.menu_popup_favorite, popup.getMenu());
        popup.setOnMenuItemClickListener(new FavoriteCouponAdapter.MyMenuItemClickListener(position));
        popup.show();
    }
    ...
    private class MyMenuItemClickListener implements PopupMenu.OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            if (itemId == R.id.remove_favorite) {
                ...
                return true;
            } else if (itemId == R.id.redimir_favorite) {
                ...
                //Toast.makeText(HomeActivity.mContext, "Redimir favorito", Toast.LENGTH_SHORT).show();
                return true;
            }
            return false;
        }
        ...
        private void agregarFavorito(final String clvPro) {
            mCoupon.addFavorite(mUser.getSes(), String.valueOf(clvPro), new ServerCallback() {
                ...
                public void onSuccess(String result) {
                    ...
                    if (mAddFav.getErr() == 0) {
                        couponModels.remove(position);
                        notifyItemRemoved(position);
                        notifyItemRangeRemoved(position, couponModels.size());

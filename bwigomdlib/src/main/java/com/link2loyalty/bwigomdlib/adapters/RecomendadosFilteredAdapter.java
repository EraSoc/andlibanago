...
public class RecomendadosFilteredAdapter extends RecyclerView.Adapter<RecomendadosFilteredAdapter.PersonViewHolder>{
    ...
    public RecomendadosFilteredAdapter(List<LovFiltered> couponModels, Context mContext,
    ...
    private void showPopupMenu(View view,int position) {
        ...
        popup.setOnMenuItemClickListener(new RecomendadosFilteredAdapter.MyMenuItemClickListener(position));
        popup.show();
    }

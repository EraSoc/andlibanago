...
public class HighlightCouponAdapter extends RecyclerView.Adapter<HighlightCouponAdapter.PersonViewHolder>{
    ...
    public HighlightCouponAdapter(List<com.link2loyalty.bwigomdlib.models2.coupon.LovRecomendados> couponModels, Context mContext,
